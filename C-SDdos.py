...
def get_Typer():
	...
	global fake_ip
	global hides
	optp = OptionParser(add_help_option=False,epilog="cyber-sorcerer DDos")
...
def usage():
    console = Console()
    MARKDOWN=("""
         	     CYBER SORCERER DDos Script V 1.1            """)
...
def usage1():
	...
	usage : python C-SDdos.py [-i] [-p] [-l]
        	-h : help
        	-i : server ip
        	-p : port server 
        	-l : Level Attack {number}
        	-f : Fake ip
            -d : Hide Logs
	example :
	    python C-SDdos.py -i 92.204.214.136 -p 80 -l 2"""
    md = Markdown(MARKDOWN)
    console.print(md,style="bold green")
    #sys.exit()
...
A powerful DDos By Cyber-Sorcerer 
    """
...
def usage3():
    ...
    Made in : Bangladesh
    Telegram : https://t.me/teamblackfalcon
    github : https://github.com/teamblackfalcon
